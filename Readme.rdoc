...
* Notifications Framework
    ...
    infinity_test --notifications growl # Using growl

    infinity_test --notifications snarl # Using snarl
...
* Lib-Notify - Linux
    ...
    run_with :rvm => ['1.8.7-p249', '1.9.1', '1.9.2'], :test_framework => :rspec, :cucumber => true
