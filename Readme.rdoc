...
giving the possibility to test with all versions of ruby you have in your RVM configuration.
...
<b> Just make Sure That you have Rspec or Cucumber (Depending if you need) </b>
