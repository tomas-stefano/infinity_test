  ...
  describe Cucumber do
    ...
    describe "#build_command_string" do
      ...
      it "should be instance of String" do
        @cucumber.build_command_string(nil).should be_instance_of(String)
      end
